...
function Toggle({ id }) {
  ...
  function handleClick(e) {
    ...
    //if none of the menu is clicked open the one with the id or if the menu clicked is diff from the already opened menu  then open the menu
...
//4)making child component as property to parent component
Menus.Menu = Menu;
Menus.Toggle = Toggle;
Menus.List = List;
Menus.Button = Button;
